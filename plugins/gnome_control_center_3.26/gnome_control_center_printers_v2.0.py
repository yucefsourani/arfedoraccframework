...
button_label         = _( "Printers" )
button_image         = [ "printer" ]
category             = _("Hardware")
title                = _("For Test")
arch                 = ["all"]
distro_name          = ["all"]
distro_version       = ["all"]
mainbuttontooltip    = _("Gnome Control Center Printers")
blockclose           = False
if_true_skip         = False
...
def Run(button):
    subprocess.Popen("/usr/bin/gnome-control-center printers",shell=True)
